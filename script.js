...
addPlayerBtn.addEventListener('click', ()=>{
  ...
  players.push({name: addPlayerInput.value, p15 : 0, p16 : 0, p17 : 0, p18 : 0, p19 : 0, p20 : 0, pBull : 0})
...
for (let i = 0; i < allfields.length; i++) {
    allfields[i].addEventListener('click', (e) => {
      ...
      if(allHits.length == 4) {
        ...
        if(players[activePlayerIndex].pBull >= 3 ) {players[activePlayerIndex].pBull = 3}
        ...
        if(players[activePlayerIndex].p20 >= 3 ) {players[activePlayerIndex].p20 = 3}
        ...
        if(players[activePlayerIndex].p19 >= 3 ) {players[activePlayerIndex].p19 = 3}    
        ...
        if(players[activePlayerIndex].p18 >= 3 ) {players[activePlayerIndex].p18 = 3}
        ...
        if(players[activePlayerIndex].p17 >= 3 ) {players[activePlayerIndex].p17 = 3}
        ...
        if(players[activePlayerIndex].p16 >= 3 ) {players[activePlayerIndex].p16 = 3}
        ...
        if(players[activePlayerIndex].p15 >= 3 ) {players[activePlayerIndex].p15 = 3}
        ...
        if(players[activePlayerIndex].pBull == 3 && players[activePlayerIndex].p20 == 3  && players[activePlayerIndex].p19 == 3  && players[activePlayerIndex].p18 == 3  && players[activePlayerIndex].p17 == 3  && players[activePlayerIndex].p16 == 3  && players[activePlayerIndex].p15 == 3) {
          ...
          playerboard.innerHTML = '🎯 ' + players[activePlayerIndex].name + ' Wins! 🎯'
          document.querySelector('.playermove').remove() //ne vidi ga
        //
        } else {
          alert('next player')  
        }   
