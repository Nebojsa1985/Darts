...
addPlayerBtn.addEventListener("click", (e) => {
  if (players.length > 3) {
    ...
    //find index of element Child node
    const child = e.target.parentElement;
    const index = Array.from(e.target.parentElement.parentElement.children).indexOf(child);
    //
...
for (let i = 0; i < allfields.length; i++) {
  allfields[i].addEventListener("click", (e) => {
    ...
    if (allHits.length == 4) {
      ...
      players[activePlayerIndex].p20 += counts["40"] == 1 ? 2 : 0;
      players[activePlayerIndex].p20 += counts["40"] > 1 ? 3 : 0;
      ...
      players[activePlayerIndex].p19 += counts["38"] == 1 ? 2 : 0;
      players[activePlayerIndex].p19 += counts["38"] > 1 ? 3 : 0;
      ...
      players[activePlayerIndex].p18 += counts["36"] == 1 ? 2 : 0;
      players[activePlayerIndex].p18 += counts["36"] > 1 ? 3 : 0;
      ...
      players[activePlayerIndex].p17 += counts["34"] == 1 ? 2 : 0;
      players[activePlayerIndex].p17 += counts["34"] > 1 ? 3 : 0;
      ...
      players[activePlayerIndex].p16 += counts["32"] == 1 ? 2 : 0;
      players[activePlayerIndex].p16 += counts["32"] > 1 ? 3 : 0;
      ...
      players[activePlayerIndex].p15 += counts["30"] == 1 ? 2 : 0;
      players[activePlayerIndex].p15 += counts["30"] > 1 ? 3 : 0;
